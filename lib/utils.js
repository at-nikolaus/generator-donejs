...
//TODO add Prompting for package.json maybe here
...
var npmKeywords = {
  app: 'donejs-app',
  plugin: 'donejs-plugin',
  generator: 'donejs-generator'
};

exports.getKeywords = function (kind, keywords) {
  if (typeof keywords === 'string') {
    var spacesAndCommas = /[\s,]+/;
    keywords = keywords.split(spacesAndCommas);
  }
  ...
  var kindKeyword = npmKeywords[kind];
  if (kindKeyword && keywords.indexOf(kindKeyword) === -1) {
    keywords = keywords.concat(kindKeyword);
  }
